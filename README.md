...
token are used as a key for a user to login to a website 

- [x] What steps can you take in your web apps to keep your data secure?
you can add a login form to give you a token 

- [x] Describe how web servers work.
its a for a user to send and retrieve data 

- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
axios put, and delete
...
- [x] Build a `PrivateRoute` component and use it to protect a route that renders the `BubblePage` component
